...
pickle_in = open('content/model.pkl', 'rb')
...
def show_another_page():
    ...
    AF3 = st.sidebar.slider("AF3 Value", 4000, 4500, key="AF3")
    F7 = st.sidebar.slider("F7 Value", 4000, 4500, key="F7")
    F3 = st.sidebar.slider("F3 Value", 4000, 4500, key="F3")
    FC5 = st.sidebar.slider("FC5 Value", 4000, 4500, key="FC5")
    T7 = st.sidebar.slider("T7 Value", 4000, 4500, key="T7")
    P7 = st.sidebar.slider("P7 Value", 4000, 4500, key="P7")
    O1 = st.sidebar.slider("O1 Value", 4000, 4500, key="O1")
    O2 = st.sidebar.slider("O2 Value", 4000, 4500, key="O2")
    P8 = st.sidebar.slider("P8 Value", 4000, 4500, key="P8")
    T8 = st.sidebar.slider("T8 Value", 4000, 4500, key="T8")
    FC6 = st.sidebar.slider("FC6 Value", 4000, 4500, key="FC6")
    F4 = st.sidebar.slider("F4 Value", 4000, 4500, key="F4")
    F8 = st.sidebar.slider("F8 Value", 4000, 4500, key="F8")
    AF4 = st.sidebar.slider("AF4 Value", 4000, 4500, key="AF4")
